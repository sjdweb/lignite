...
{
    public delegate void MarketDataUpdatedEventEventHandler(object sender, MarketDataUpdatedEventArgs e);

    public class MarketDataUpdatedEventArgs : EventArgs
    {
        public string senderID { get; set; }
        public object market { get; set; }

        public MarketDataUpdatedEventArgs() { }

        public MarketDataUpdatedEventArgs(string senderID, object market)
        {
